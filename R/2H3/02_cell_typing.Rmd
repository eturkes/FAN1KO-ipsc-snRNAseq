...
packages <- c("conflicted", "Seurat", "dplyr", "ggrepel", "ggplot2")
...
tran_markers <- tran_markers[1:4, ] # Just look at top 4 markers.

for (i in seq(ncol(tran_markers))) {
  print(colnames(tran_markers)[i])
  print(gene_plot(list(seurat = seurat), "seurat", tran_markers[ , i]))
}
```
