...
cluster_pipeline <- function(
  seurat, cache_dir, sub_name, protocol, vars_to_regress, parallel_override, resolution = NULL, cc = TRUE
) {
...
word_cloud = function(x, width = NULL){
  t.rW = c("cell", "process", "negative", "positive",
           ...
           "volumesensitive", "box", "pigment",
           "bundle", "chctype", "outward", "divergent", "conserved",
           "driving", "finger",
           "organization",

           "depolarization",
           "minusend", "comprises",
           "proteincoupled", "ruffle",
           "spindle", "cortex", "thiolester",
           "rnan", "rcosr", "localization", "dorsalventral",
           "segment", "granules", "sound", "acceptor",
           "primary", "network", "mechanism", "bubble",
           "vibration", "trimers", "domains",
           "activating", "heavy", "different", "retention",
           "apparatus", "pad", "tubular", "organizing",
           "faces", "subunit", "lungs", "sshaped", "ribosome",
           "synapse", "dendritic")
